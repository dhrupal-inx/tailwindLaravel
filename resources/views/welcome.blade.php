...
<!-- Section 4 -->
<div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 bg-white">
<div class="lg:text-center">
      <!-- <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Transactions</h2> -->
      <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
        Our Services
...
<div class="rounded-lg mt-10 overflow-hidden shadow divide-y divide-gray-200 bg-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
